...
# By Day of Week
week_df <- fraud %>% filter(is_fraud == 1) %>%
  select(DayOfWeek, is_fraud)
ggplot(week_df, aes(x = DayOfWeek)) + geom_bar() +
  labs(title = 'Count of Fraud Occurrences throughout the Week',
...
1: log
  - balanced accuracy is 0.85
  - important factors: amount, hour, category
  - feature selection: none
  - interpretability: high
2: lasso
  - balanced accuracy is .862
  - important factors: amount
  - feature selection: lambda penalty
  - interpretability: moderate
3: xgboost
  - accuracy is 0.97
  - important factors: amount, hour
...
Discuss the results/findings coming from the model. What were
the insights gained from the model? Provide a summary of the
report and the key points from the analysis.
