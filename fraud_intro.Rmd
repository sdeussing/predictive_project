...
All variables seem to have a relationship with the response variable. For the purpose of prediction, 'merchant' may have too many variables to use in modeling. Additionally, we can use time of day in our modeling in different forms - hour, period of the day, exact time, etc. We can also use date as either true date or the day of the week.

We will also visualize location as a potential variable. However, this plot is more exploratory to understand the dataset we are working with.
```{r Fraud Map}
